///
/// Auto-generated TCP server for optimizer: drone_controller
///
...
fn execution_handler(
    ...
    match initial_guess {
        ...
        Some(u0) => {
            if u0.len() != DRONE_CONTROLLER_NUM_DECISION_VARIABLES {
    ...
    if parameter.len() != DRONE_CONTROLLER_NUM_PARAMETERS {
...
fn main() {
    let matches = App::new("OpEn TCP Server [drone_controller]")
        .version("0.0.0")
        .author("John Smith")
